...
from runtime.infrastructure.http.srm.manager_gateway import _derive_field_buckets_from_field_errors
...
def main() -> None:
    ...
    grpc_clients = build_runtime_grpc_clients(settings)
    if grpc_clients.risk_order_intent_client is not None:
        print(
    ...
    container = build_runtime_container(
        settings,
        manager_client=grpc_clients.manager_client,
        risk_order_intent_client=grpc_clients.risk_order_intent_client,
    )
