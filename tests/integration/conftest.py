"""Integration fixtures: bootstrap tests validate pipeline wiring, not mypy on fixture strategies."""
...
def _stub_mypy_for_bootstrap_integration(monkeypatch: pytest.MonkeyPatch) -> None:
