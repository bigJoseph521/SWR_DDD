...
from runtime.integration.epoch_time import utc_datetime_to_epoch_millis
...
def market_data_redis_keys_from_settings(obj: Any) -> MarketDataRedisKeys:
    """Build :class:`MarketDataRedisKeys` from :class:`~runtime.config.settings.Settings` (or duck-typed)."""
